...
import games.application.handler.copyGamesFromRepository.CopyGamesFromRepositoryResponse;
...
public class UpdateGamesIndexCommandHandlerTest {
    ...
    public void itShouldCopyGamesFromARepositoryToAnother() throws InterruptedException {
        ...
        UpdateGamesIndexCommandHandler handler = new UpdateGamesIndexCommandHandler(
        ...
        CompletionStage<UpdateGamesIndexResponse> handlerResponse = handler.handle();
